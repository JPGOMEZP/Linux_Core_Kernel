...
# This script disassemble and assemble DSDT ACPI tables with 'iasl' command.
# 'iasl' commnad is an ACPI Source Language compiler/decompiler.
...
sudo rm $DSL_FILE $DAT_FILE 2>/dev/null

# DECOMPILE DTDT SOURCE
sudo cat /sys/firmware/acpi/tables/DSDT > $DAT_FILE
sudo iasl -d $DAT_FILE
