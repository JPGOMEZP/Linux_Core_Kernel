...
if [ $IS_EXECUTED -eq 1 ]; then
  ...
  if [ $TEST_SCENARIO == "wdt-bat-tests" ]; then
    ...
    if [ $REBOOT -eq 0 ]; then
      ...
      sed -i 's/#WDT_FUNC_LOAD_DRIVER_AS_MODULE/WDT_FUNC_LOAD_DRIVER_AS_MODULE/g' ${thispath}/../../../runtest/wdt/wdt-bat-tests
      sed -i 's/#WDT_FUNC_UNLOAD_DRIVER_AS_MODULE/WDT_FUNC_UNLOAD_DRIVER_AS_MODULE/g' ${thispath}/../../../runtest/wdt/wdt-bat-tests
      sed -i 's/#WDT_FUNC_BIND_UNBIND_DRIVER/WDT_FUNC_BIND_UNBIND_DRIVER/g' ${thispath}/../../../runtest/wdt/wdt-bat-tests
      sed -i 's/#WDT_FUNC_SETTIMEOUT/WDT_FUNC_SETTIMEOUT/g' ${thispath}/../../../runtest/wdt/wdt-bat-tests
      sed -i 's/#WDT_FUNC_WATCHDOG_SIMPLE/WDT_FUNC_WATCHDOG_SIMPLE/g' ${thispath}/../../../runtest/wdt/wdt-bat-tests
