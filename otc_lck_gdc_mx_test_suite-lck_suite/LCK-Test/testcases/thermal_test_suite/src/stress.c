 ...
 * Rivas Luis <luis.miguel.rivas.zepeda@intel.com>
 *
 ...
 *      - Refactored stress functions
 *      - Refactored runtime logging macros
 *
 */
...
#include <unistd.h>
#include <sys/wait.h>
#include "st_runtime_log.h"
#include "st_stress.h"

#define PACKAGE     "stress"
#define VERSION     "LTP-DDT-IA"
...
extern int global_debug = 2;
extern char* global_progname = PACKAGE;
